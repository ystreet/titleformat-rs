...
impl Environment {
    fn add_default_functions(&mut self) {
        self.funcs.insert(
            String::from("add"),
            FuncValue::NativeFnError(functions::num::add::add),
        );
        self.funcs.insert(
            String::from("sub"),
            FuncValue::NativeFnError(functions::num::sub::sub),
        );
        self.funcs.insert(
            String::from("mul"),
            FuncValue::NativeFnError(functions::num::mul::mul),
        );
        self.funcs.insert(
            String::from("div"),
            FuncValue::NativeFnError(functions::num::div::div),
        );
        self.funcs.insert(
            String::from("min"),
            FuncValue::NativeFnError(functions::num::min::min),
        );
        self.funcs.insert(
            String::from("max"),
            FuncValue::NativeFnError(functions::num::max::max),
        );

        self.funcs.insert(
            String::from("eq"),
            FuncValue::NativeCondFnError(functions::num::control::eq),
        );
        self.funcs.insert(
            String::from("ne"),
            FuncValue::NativeCondFnError(functions::num::control::ne),
        );
        self.funcs.insert(
            String::from("gt"),
            FuncValue::NativeCondFnError(functions::num::control::gt),
        );
        self.funcs.insert(
            String::from("gte"),
            FuncValue::NativeCondFnError(functions::num::control::gte),
        );
        self.funcs.insert(
            String::from("lt"),
            FuncValue::NativeCondFnError(functions::num::control::lt),
        );
        self.funcs.insert(
            String::from("lte"),
            FuncValue::NativeCondFnError(functions::num::control::lte),
        );

        self.funcs.insert(
            String::from("if"),
            FuncValue::NativeCondFnError(functions::control::if_::if_),
        );
        self.funcs.insert(
            String::from("if2"),
            FuncValue::NativeCondFnError(functions::control::if2::if2),
        );
        self.funcs.insert(
            String::from("if3"),
            FuncValue::NativeCondFnError(functions::control::if3::if3),
        );
        self.funcs.insert(
            String::from("ifequal"),
            FuncValue::NativeCondFnError(functions::control::ifequal::ifequal),
        );
        self.funcs.insert(
            String::from("ifgreater"),
            FuncValue::NativeCondFnError(functions::control::ifgreater::ifgreater),
        );
        self.funcs.insert(
            String::from("iflonger"),
            FuncValue::NativeCondFnError(functions::control::iflonger::iflonger),
        );
        self.funcs.insert(
            String::from("select"),
            FuncValue::NativeCondFnError(functions::control::select::select),
        );
        self.funcs.insert(
            String::from("and"),
            FuncValue::NativeCondFnError(functions::control::and::and),
        );
        self.funcs.insert(
            String::from("or"),
            FuncValue::NativeCondFnError(functions::control::or::or),
        );
        self.funcs.insert(
            String::from("xor"),
            FuncValue::NativeCondFnError(functions::control::xor::xor),
        );
        self.funcs.insert(
            String::from("not"),
            FuncValue::NativeCondFnError(functions::control::not::not),
        );

        self.funcs.insert(
            String::from("crlf"),
            FuncValue::NativeCondFnError(functions::str::constants::crlf),
        );
        self.funcs.insert(
            String::from("tab"),
            FuncValue::NativeCondFnError(functions::str::constants::tab),
        );
        self.funcs.insert(
            String::from("noop"),
            FuncValue::NativeCondFnError(functions::str::constants::noop),
        );

        self.funcs.insert(
            String::from("upper"),
            FuncValue::NativeCondFnError(functions::str::case::upper),
        );
        self.funcs.insert(
            String::from("lower"),
            FuncValue::NativeCondFnError(functions::str::case::lower),
        );
        self.funcs.insert(
            String::from("firstalphachar"),
            FuncValue::NativeCondFnError(functions::str::case::firstalphachar),
        );

        self.funcs.insert(
            String::from("len"),
            FuncValue::NativeCondFnError(functions::str::size::len),
        );
        self.funcs.insert(
            String::from("longer"),
            FuncValue::NativeCondFnError(functions::str::size::longer),
        );

        self.funcs.insert(
            String::from("stripprefix"),
            FuncValue::NativeCondFnError(functions::str::modify::stripprefix),
        );
        self.funcs.insert(
            String::from("swapprefix"),
            FuncValue::NativeCondFnError(functions::str::modify::swapprefix),
        );
        self.funcs.insert(
            String::from("cut"),
            FuncValue::NativeCondFnError(functions::str::modify::cut),
        );
        self.funcs.insert(
            String::from("left"),
            FuncValue::NativeCondFnError(functions::str::modify::left),
        );
        self.funcs.insert(
            String::from("num"),
            FuncValue::NativeCondFnError(functions::str::format::num),
        );

        self.funcs.insert(
            String::from("meta"),
            FuncValue::NativeEnvFnError(Environment::meta_value),
        );
        self.funcs.insert(
            String::from("meta_sep"),
            FuncValue::NativeEnvFnError(Environment::meta_sep_value),
        );
        self.funcs.insert(
            String::from("meta_num"),
            FuncValue::NativeEnvFnError(Environment::meta_num_value),
        );
        self.funcs.insert(
            String::from("meta_test"),
            FuncValue::NativeEnvFnError(Environment::meta_test_value),
        );
        self.funcs.insert(
            String::from("get"),
            FuncValue::NativeEnvFnError(Environment::get_value),
        );
        self.funcs.insert(
            String::from("put"),
            FuncValue::NativeEnvFnError(Environment::put_value),
        );
        self.funcs.insert(
            String::from("puts"),
            FuncValue::NativeEnvFnError(Environment::puts_value),
        );

        self.funcs.insert(
            String::from("year"),
            FuncValue::NativeCondFnError(functions::str::datetime::year),
        );
    }
    ...
    fn puts_value(&self, args: Vec<Value>) -> Result<Value, Error> {
        match args.len() {
            2 => Ok(value_string(
                {
                    self.puts(&args[0].val, &args[1].val);
                    ""
                },
                true,
            )),
    ...
    fn meta_sep_value(&self, args: Vec<Value>) -> Result<Value, Error> {
        match args.len() {
            ...
            _ => Err(InvalidNativeFunctionArgs(
                String::from("meta_sep"),
                args.len(),
            )),
        }
    ...
    fn meta_test_value(&self, args: Vec<Value>) -> Result<Value, Error> {
        match args.len() {
            0 => Err(InvalidNativeFunctionArgs(
                String::from("meta_num"),
                args.len(),
            )),
            _ => Ok(value_string(
                "",
                args.iter().all(|i| self.meta_num(&i.val) > 0),
            )),
        }
    }
...
mod tests {
    ...
    fn test_put_get_value() {
        ...
        assert_eq!(
            env.put_value(vec![value_string("a", true), value_string("val", true)])
                .unwrap(),
        ...
        assert_eq!(
            env.puts_value(vec![value_string("b", true), value_string("bar", true)])
                .unwrap(),
            value_string("", true)
        );
        assert_eq!(
    ...
    fn test_call() {
        ...
        assert_eq!(
            env.call(
                "add",
                vec![value_string("2", true), value_string("2", true)]
            )
            .unwrap(),
            value_string("4", true)
        );
    ...
    fn test_call_unknown() {
        let env = Environment::new(HashMap::new());
        assert_eq!(
            env.call("unknown", vec![]).err().unwrap(),
    ...
    fn test_meta() {
        ...
        assert_eq!(
            env.meta_value(vec![value_string("a", true)]).unwrap(),
            value_string("0, 1, 2, 3", true)
        );
        assert_eq!(
            env.meta_value(vec![value_string("a", true), value_string("1", true)])
                .unwrap(),
            value_string("1", true)
        );
        assert_eq!(
            env.meta_value(vec![value_string("a", true), value_string("1000", true)])
                .unwrap(),
            value_string("?", false)
        );
    }
    ...
    fn test_meta_sep() {
        ...
        let env = Environment::new(m);
        assert_eq!(
            env.meta_sep_value(vec![value_string("a", true), value_string("|", true)])
                .unwrap(),
            value_string("0|1|2|3", true)
        );
        assert_eq!(
            env.meta_sep_value(vec![
                value_string("a", true),
                value_string("|", true),
                value_string("^", true)
            ])
    ...
    fn test_meta_num() {
        ...
        let env = Environment::new(m);
        assert_eq!(
            env.meta_num_value(vec![value_string("a", true)]).unwrap(),
            value_string("4", true)
        );
        assert_eq!(
            env.meta_num_value(vec![value_string("unknown", true)])
                .unwrap(),
            value_string("0", true)
        );
    }
    ...
    fn test_meta_test() {
        ...
        m.insert(String::from("b"), vec![String::from("4")]);
        let env = Environment::new(m);
        assert_eq!(
            env.meta_test_value(vec![value_string("a", true), value_string("b", true)])
                .unwrap(),
            value_string("", true)
        );
        assert_eq!(
            env.meta_test_value(vec![value_string("unknown", true),])
                .unwrap(),
            value_string("", false)
        );
    }
